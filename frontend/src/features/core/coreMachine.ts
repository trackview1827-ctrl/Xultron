...
export type CoreEvent =
  ...
  | { type: 'COMPLETE' } | { type: 'CANCEL' } | { type: 'FAIL' } | { type: 'RECOVER' } | { type: 'RETRY' }
...
const transitions: Record<CoreState, Partial<Record<CoreEvent['type'], CoreState>>> = {
  ...
  LISTENING: { NETWORK_LOST: 'OFFLINE', THINK: 'THINKING', COMPLETE: 'ONLINE', CANCEL: 'ONLINE', FAIL: 'ERROR' },
  THINKING: { NETWORK_LOST: 'OFFLINE', SPEAK: 'SPEAKING', COMPLETE: 'ONLINE', CANCEL: 'ONLINE', FAIL: 'ERROR' },
  SPEAKING: { NETWORK_LOST: 'OFFLINE', COMPLETE: 'ONLINE', CANCEL: 'ONLINE', FAIL: 'ERROR' },
  ERROR: { NETWORK_LOST: 'OFFLINE', RETRY: 'CONNECTING', RECOVER: 'ONLINE' },
}
